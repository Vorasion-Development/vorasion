...
export type DiscordCommandContext<T extends BotCommandConstructor | BotSubcommandConstructor> = {
  interaction: CommandInteraction<T>
  container: Container
}

type CommandInteraction<T extends BotCommandConstructor | BotSubcommandConstructor> = T extends BotCommandConstructor
